...
<col width="30%" />
  ...
  <tr>
    <th align="center"><i class="fas fa-microchip fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-level-up-alt fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-smile fa-5x"></i><br></th>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td align="center" style="vertical-align: top;">Determine the level of technology that students have</td>
    <td></td>
    <td align="center" style="vertical-align: top;">What is their comfort level with technology</td>
    <td></td>
    <td align="center" style="vertical-align: top;">What are their expectations of a Virtual Courtroom</td>
  </tr>
</table>
...
<col width="30%" />
  ...
  <tr>
    <th align="center"><i class="fas fa-laptop fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-cubes fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-exclamation fa-5x"></i><br></th>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td align="center" style="vertical-align: top;">73% had laptops compared to 27% had desktops. This indicated the level of technology that students had, which we kept in mind regarding graphical requirements of the tool</td>
    <td></td>
    <td align="center" style="vertical-align: top;">Student’s expectations of a “virtual courtroom” were a 3D courtroom environment that extended functionality beyond a Zoom or MS Teams call</td>
    <td></td>
    <td align="center" style="vertical-align: top;">The importance of mooting for students (mock trials), as it was a core activity for Law students at the OU Law program</td>
  </tr>
</table>
...
- When doing mooting (mock trials) virtually, video was very important as the student would read the judge's expressions and body lanugage when they are presenting their submissions
- Students want additional tools to help them track specific things like time and notes, which meant that they wanted similar things like an in-person mooting session would have
...
<col width="30%" />
  ...
  <tr>
    <th align="center"><i class="fas fa-vr-cardboard fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-chalkboard-teacher fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-cube fa-5x"></i><br></th>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td align="center" style="vertical-align: top;">Virtual Reality: We looked at this during our Ideation phase and saw it was not feasble due to the cost of the technology required for students and the hardware needed to power it.</td>
    <td></td>
    <td align="center" style="vertical-align: top;">Deluxe Zoom: Students we spoke with felt that Zoom or Teams was not immersive and didn't provide an experience close to a in-person mooting (mock trial) session.</td>
    <td></td>
    <td align="center" style="vertical-align: top;">3D Virtual Environment: The use of avatars in a courtroom environment would provide a level of immersion and also interaction, since it would be multiplayer. We looked into Unity and saw a big opportunity in integrating different technologies to make this possible.</td>
  </tr>
</table>
...
![image]({{site.baseurl}}/assets/img/vr-ft-3.png)
...
<div class="video-container"><iframe width="560" height="315" src="https://www.youtube.com/embed/RSbapMcYYLY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
...
![image]({{site.baseurl}}/assets/img/vr-ft-21.png)
<i style="font-size:12px;">Wireframes</i>

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-4.png)
<i style="font-size:12px;">First iteration - Menu</i>

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-5.png)
<i style="font-size:12px;">First iteration - Mode select</i>

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-6.png)
<i style="font-size:12px;">First iteration - Role select</i>

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-7.png)
<i style="font-size:12px;">Second iteration - Menu</i>

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-8.png)
<i style="font-size:12px;">Second iteration - Join screen</i>

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-9.png)
<i style="font-size:12px;">Second iteration - Avatar edit</i>
...
<col width="30%" />
  ...
  <tr>
    <th align="center"><i class="fas fa-font fa-5x"></i><br></th>
    <th></th>
    <th align="center"><i class="fas fa-sticky-note fa-5x"></i><br></th>
    <th></th>
  ...
  <tr>
    <td align="center" style="vertical-align: top;">Implementing a font that would be easy to read</td>
    <td></td>
    <td align="center" style="vertical-align: top;">Tutorials when the student enters the count room for movement and interactions</td>
    <td></td>
    <td align="center" style="vertical-align: top;">Adjusting the language of the UI, so it is more familiar with Law students</td>
  </tr>
</table>
...
![image]({{site.baseurl}}/assets/img/vr-ft-10.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-11.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-12.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-13.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-14.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-15.png)
...
![image]({{site.baseurl}}/assets/img/vr-ft-16.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-17.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-18.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-19.png)

<br>

![image]({{site.baseurl}}/assets/img/vr-ft-20.png)
